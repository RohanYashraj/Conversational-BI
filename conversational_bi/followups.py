...
def _grounding_message() -> Message:
    ...
    return Message(
        ...
        content=(
            ...
            "- Every suggestion must be a DATA question: a metric for a slice, "
            "a breakdown, a trend over quarters, or a comparison. No advice, "
            "strategy, or open-ended 'explain factors' asks.\n"
            "- Good shapes: 'Break <value> down by <dimension>', 'Show the "
            "quarterly <metric> trend for <value>', 'Which <dimension> drives "
            "<metric> in <value>?', 'Compare <value A> with <value B>'.\n"
