...
>(({ className, sideOffset = 4, type = 'default', ...props }, ref) => (
  <TooltipPrimitive.Content
    ...
    className={cn(
      ...
      type === 'default' && 'border border-border bg-popover text-popover-foreground shadow-sm',
      type === 'copy' &&
        'bg-gradient-to-r from-brand-badgeFrom to-brand-badgeTo text-primary-foreground',
