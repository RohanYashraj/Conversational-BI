...
export function EntitySelector() {
  ...
  if (currentEntities.length === 0) {
    return (
      <Select disabled>
        <SelectTrigger className="h-9 w-full rounded-xl border border-border bg-secondary text-xs font-semibold uppercase tracking-wide text-muted-foreground opacity-70">
  ...
  return (
    ...
    >
      <SelectTrigger className="h-9 w-full rounded-xl border border-border bg-secondary text-xs font-semibold uppercase tracking-wide text-foreground">
        <SelectValue placeholder={placeholder} />
      </SelectTrigger>
      <SelectContent className="font-sans shadow-lg">
