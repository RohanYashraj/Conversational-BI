...
const Sessions = () => {
  ...
  const scrollRegionClass = cn(
    'min-h-0 flex-1 overflow-y-auto font-sans [scrollbar-gutter:stable_both-edges] transition-opacity duration-300 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar]:transition-opacity [&::-webkit-scrollbar]:duration-300',
    isScrolling
      ? '[&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-border [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar]:opacity-0'
  ...
  if (isSessionsLoading || isEndpointLoading) {
    return (
      <div className="flex min-h-0 w-full min-w-0 flex-1 flex-col">
        <div className="mb-2 w-full shrink-0 text-xs font-medium uppercase">
          Sessions
        </div>
        <div
          className={cn(scrollRegionClass, 'mt-1')}
  ...
  return (
    <div className="flex min-h-0 w-full min-w-0 flex-1 flex-col">
      <div className="mb-2 w-full min-w-0 shrink-0 text-xs font-medium uppercase">
        Sessions
      </div>
      <div
