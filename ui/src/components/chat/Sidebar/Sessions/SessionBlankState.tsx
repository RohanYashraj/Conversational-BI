...
const SessionBlankState = () => {
  ...
  return (
    <div className="mt-1 flex w-full min-w-0 items-center justify-center rounded-xl border border-border/50 bg-muted/40 pb-6 pt-4">
      <div className="flex flex-col items-center gap-1">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="max-w-[210px] text-center text-sm text-muted-foreground">
            {errorMessage}
          </p>
        </div>
      </div>
